...
public class ReportsIncidentsFragment extends Fragment {
    ...
    private Boolean checkDates(){
        ...
        if(calendarFrom.after(calendarTo)){
            Toast.makeText(thisContext,"La fecha desde debe ser menor o igual a la fecha hasta.", Toast.LENGTH_SHORT);
            datesOk = false;
        }else{
            ...
            if(daysDifference > MAX_DAYS_DIFF){
                Toast.makeText(thisContext,"El período seleccionado no puede superar los "+ MAX_DAYS_DIFF +" días.", Toast.LENGTH_SHORT);
                datesOk = false;
            }
